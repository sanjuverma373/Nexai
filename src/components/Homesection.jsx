      ...
      <div className=' max-w-[1180px] px-3 mx-auto w-full'>
        <div className=' grid lg:grid-cols-2 gap-6 sm:gap-[70px]'>
          ...
          <div className=' pt-6 sm:pt-[39px] pb-6 sm:pb-[72px]'>
            <h2 data-aos="zoom-in" className=' text-center lg:text-start font-Recharge font-bold text-[25px] sm:text-[40px] leading-[38px] sm:leading-[50px] text-[#02CDCF] pb-[16px]'>Ai-Powered Home Assistant</h2>
