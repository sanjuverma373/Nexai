      ...
      <div className=' max-w-[1180px] px-3 mx-auto w-full'>
        <div className=' grid lg:grid-cols-2 gap-6 sm:gap-[52px]'>
          ...
          <div className=' pt-6 sm:pt-[39px] pb-6 sm:pb-[72px]'>
            ...
            <p data-aos="zoom-in" className=' text-center lg:text-start font-Poppins font-normal text-[13px] sm:text-[16px] leading-[21px] sm:leading-[25px] text-[#B4B4B4] pb-[40px] max-w-[505px] mx-auto lg:mx-0'>assist with cooking by suggesting ingredients, track your fitness and nutrition goals, and even handle bill payments.</p>
