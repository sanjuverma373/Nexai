...
const Sliderssection = () => {
        ...
        return (
                <div id='marketplace' className=' pt-[40px] sm:pt-[80px] md:pt-[150px] lg:pt-[200px] relative overflow-x-clip z-10'>
                        ...
                        <h3 data-aos="zoom-in" className='font-Recharge font-bold text-[25px] sm:text-[50px] leading-[38px] sm:leading-[50px] text-[#02CDCF] pb-[16px] text-center px-3'>NexAi does all this. And more.</h3>
                        <p data-aos="zoom-in" className=' font-Poppins font-normal text-[13px] sm:text-[16px] leading-[21px] sm:leading-[25px] text-[#B7B7B7] text-center max-w-[912px] mx-auto pb-[40px] sm:pb-[90px] px-3'>Nexai is an advanced home assistant that will revolutionize the way we interact with our smart devices at home. Powered by sophisticated artificial intelligence, it leverages blockchain technology to offer a secure and efficient user experience.</p>
