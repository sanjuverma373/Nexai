                        ...
                        <div className=' max-w-[1200px] px-3 mx-auto w-full'>
                                <div className=' flex justify-end '>
                                        <div className=' flex items-center justify-between lg:w-[65%]'>
                                                <ul className={`  ${first ? "left-0" : "left-[-100%]"} flex items-center duration-300 justify-center gap-[20px] max-md:flex-col max-md:w-full max-md:h-full max-md:fixed max-md:top-0 max-md:z-20  max-md:bg-[url(./assets/images/webpimg/nav-bg.webp)] max-md:bg-black bg-center bg-cover bg-no-repeat`}>
