  ...
  return (
    <div id='about' className=' px-3 sm:px-[50px] flex justify-center'>
      <div className=' border border-[#FCFCFC] rounded-[24px] relative  overflow-x-clip min-h-[] lg:min-h-[810px] h-full max-w-[1340px] w-full '>
        <h2 data-aos="zoom-in" className=' font-Recharge font-bold text-[25px] sm:text-[40px] leading-[38px] sm:leading-[50px] text-white text-center pt-[24px] sm:pt-[80px] pb-[16px]'>Unique features</h2>
