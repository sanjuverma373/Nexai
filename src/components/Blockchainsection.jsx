...
const Blockchainsection = () => {
        ...
        return (
                <div id='nexchat'  className=' pt-[40px] sm:pt-[80px] md:pt-[160px] overflow-x-clip relative z-10'>
                        ...
                        <h3 data-aos="zoom-in" className='font-Recharge font-bold text-[25px] sm:text-[40px] leading-[38px] sm:leading-[50px] text-[#02CDCF] pb-[16px] text-center'>Blockchain & AI technology</h3>
