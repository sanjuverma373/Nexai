...
const Headersection = () => {
        return (
                <div className=' px- lg:px-[30px] pt-[10px] pb-0 sm:pb-[55px]'>
                        <div className='bg-[url(./assets/images/webpimg/header-bg.webp)] bg-no-repeat bg-center lg:bg-size min-h-screen lg:min-h-[810px] 2xl:min-h-screen relative overflow-x-clip lg:mt-[0] '>
                                <Navsection />
                                <div className=' max-w-[1140px] mx-auto px-3 w-full'>
                                        <div className=' min-h-[355px] flex pt-[35px] sm:pt-[104px] flex-col justify-center relative z-10'>
