                        ...
                        <div className='lg:px-[30px] lg:pt-[10px] pb-0 sm:pb-[55px]'>
                                <div className='bg-[url(./assets/images/webpimg/header-bg.webp)] bg-no-repeat bg-center lg:bg-size min-h-[96vh] overflow-x-clip lg:mt-[0] '>
                                        ...
                                        <div className=' max-w-[1140px] mx-auto px-3 w-full'>
                                                <div className=' min-h-[355px] pt-[35px] 2xl:pt-[120px] relative z-10'>
                                                        ...
                                                        <h2 className=' mt-5 lg:mt-10 xl:mt-[90px] pb-[16px] font-Recharge font-bold text-[37px] sm:text-[45px] md:text-[60px] leading-[43px] sm:leading-[75px] text-white max-w-[577px] '><span className='text-[#02CDCF]'>Nexai</span> is an advanced AI-powered home assistant</h2>
