...
const Headersection = () => {
        return (
                <div className='lg:px-[30px] lg:pt-[10px] pb-0 sm:pb-[55px]'>
                        <div className='bg-[url(./assets/images/webpimg/header-bg.webp)] bg-no-repeat bg-center bg-cover lg:bg-size min-h-screen lg:min-h-[810px] 2xl:min-h-screen relative overflow-x-clip lg:mt-[0] '>
                                <Navsection />
